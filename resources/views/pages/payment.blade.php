                        ...
                        <div class="shipping">
                            ...
                            <div class="shipping-form">
                                <form id="shipping-zip-form" method="post" action="#">
                                    <ul class="form-list">
                                        <li>
                                            <label class="required" for="email">{{ trans('messeage.user_name') }}: <em>*</em></label>
                                            <div class="input-box">
                                                <input type="text" name="estimate_postcode" id="email" class="input-text validate-postcode">
                                            </div>
                                        </li>
                                        <li>
                                            <label class="required" for="phone">{{ trans('messeage.phone') }}: <em>*</em></label>
                                            <div class="input-box">
                                                <input type="text" name="estimate_postcode" id="phone" class="input-text validate-postcode">
                                            </div>
                                        </li>
                                        <li>
                                            <label class="required" for="address">{{ trans('messeage.address') }}: <em>*</em></label>
                                            <div class="input-box">
                                                <input type="text" name="estimate_postcode" id="address" class="input-text validate-postcode">
                                            </div>
                                        </li>
                                        <li>
                                            <label class="required" for="city">{{ trans('messeage.city') }}: <em>*</em></label>
                                            <div class="input-box">
                                                <input type="text" name="estimate_postcode" id="city" class="input-text validate-postcode">
                                            </div>
                                        </li>
                                        <li>
                                            <label class="required" for="country">{{ trans('messeage.country') }}: <em>*</em></label>
                                            <div class="input-box">
                                                <input type="text" name="estimate_postcode" id="country" class="input-text validate-postcode">
                                            </div>
                                        </li>
                                        <li>
                                            <label for="note">{{ trans('messeage.note') }}:</label>
                                            <div class="input-box">
                                                <input type="textarear" name="estimate_postcode" id="note" class="input-text validate-postcode">
                                            </div>
                                        </li>
                                    </ul>
                                </form>
                            ...
                            <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="a-right"><span class="price">$77.40</span></td>
                                    </tr>
                                    <tr>
